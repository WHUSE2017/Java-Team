        ...
        $.ajax({
            ...
            success : function (json) {
                ...
                for(var i=0;i<data.length;i++){
                    ...
                    //$(this).html(content);
                    for (var key in emojiprototypedata) { // 遍历Set
                        var value=emojiprototypedata[key][3];
                        html=html.replace(":"+value+":","<img src='../../res/plugins/emoji/emoji/"+key+".png'/>");
                    }
